      ...
      <div class="col-md-8">
        <div class="custom-card-register">
          <div class="card-header">{{ __('Custom') }}</div>
            <div class="card-body">
              <form method="POST" action="/panel/custom/store"> 
                {{-- {{ route('/panel/custom/store') }} --}}
                  @csrf
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                          <input id="background" type="url" class="form-control{{ $errors->has('background') ? ' is-invalid' : '' }}" name="background" value="{{ old('background') }}" placeholder="url background" required autofocus>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                          ...
                          <input id="chosen-color" type="text" class="col-5 form-control{{$errors->has('chosen-color') ? ' is-invalid' : '' }}" name="chosen-color" value="{{ old('chosen-color') }}" onchange="javascript:document.getElementById('color').value = document.getElementById('chosen-color').value;" required autofocus>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                          <input id="image1" type="url" class="form-control{{ $errors->has('image1') ? ' is-invalid' : '' }}" name="image1" value="{{ old('image1') }}" placeholder="url image1" required autofocus>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                          <input id="image2" type="url" class="form-control{{ $errors->has('image2') ? ' is-invalid' : '' }}" name="image2" value="{{ old('image2') }}" placeholder="url image2" required autofocus>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                          <input id="image3" type="url" class="form-control{{ $errors->has('image3') ? ' is-invalid' : '' }}" name="image3" value="{{ old('image3') }}" placeholder="url image3" required autofocus>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                          <input id="image4" type="url" class="form-control{{ $errors->has('image4') ? ' is-invalid' : '' }}" name="image4" value="{{ old('image4') }}" placeholder="url image4"  required autofocus>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                          <input id="image5" type="url" class="form-control{{ $errors->has('image5') ? ' is-invalid' : '' }}" name="image5" value="{{ old('image5') }}" placeholder="url image5" required autofocus>

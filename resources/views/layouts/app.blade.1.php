        ...
        <nav class="navbar navbar-expand-md navbar-light custom-nav">
            <div class="container">
                {{-- <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'SBRP') }}
                </a> --}}
                {{-- <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
                    <span class="navbar-toggler-icon"></span>
                </button> --}}
                <a href="" class="general-button p-2 m-2">SBRP Website</a>
                <a href="" class="general-button p-2 m-2">Home</a>
                <a href="" class="general-button p-2 m-2">Contact</a>
